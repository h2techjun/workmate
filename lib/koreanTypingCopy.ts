...
export const KOREAN_TYPING_COPY: Record<Locale, TypingCopy> = {
  ko: {
    metaTitle: "타자 연습 게임 — 무료 온라인 한글 타자연습(두벌식)",
    metaDesc:
      "무료 온라인 타자 연습 게임. 초성·중성·종성이 한 글자로 합쳐지는 과정을 실시간으로 보며 두벌식 한글 타자를 익히고, 분당 타수·정확도·콤보를 측정. 자모→단어→문장 단계별, 가입·설치 없이 브라우저에서 바로.",
    keywords: [
      "타자연습",
      "타자게임",
      "타자 연습 게임",
  ...
  en: {
    metaTitle: "Typing Practice Game — Free Online Korean Typing (Dubeolsik)",
    metaDesc:
      "Free online typing practice game. Watch initial, medial, and final consonants assemble into a syllable in real time, learn the standard dubeolsik Korean keyboard, and track speed, accuracy, and combo. Jamo → words → sentences, no signup.",
    keywords: [
      "typing practice",
      "typing game",
    ...
    eyebrow: "Typing Practice · Game",
    h1: "Typing Practice Game",
    intro:
  ...
  zh: {
    metaTitle: "打字练习游戏 — 免费在线韩语打字练习(标准键盘)",
    metaDesc:
      "免费在线韩语打字练习游戏。实时观看初声·中声·终声如何合成一个音节，边玩边掌握标准两拍式(두벌식)韩语键盘，并测量每分钟打字数、准确率与连击数。从字母到单词再到句子分阶段练习，无需注册与安装，浏览器直接玩。",
    keywords: [
      "打字练习",
      "打字游戏",
      "打字练习游戏",
  ...
  vi: {
    metaTitle: "Game luyện gõ phím — Luyện gõ tiếng Hàn miễn phí online (dubeolsik)",
    metaDesc:
      "Game luyện gõ phím miễn phí online. Xem phụ âm đầu·nguyên âm·phụ âm cuối ghép thành một âm tiết theo thời gian thực, học bàn phím chuẩn dubeolsik tiếng Hàn và đo tốc độ, độ chính xác, combo. Từ chữ cái → từ → câu, không cần đăng ký.",
    keywords: [
      "luyện gõ phím",
      "game gõ phím",
      "luyện gõ tiếng Hàn",
    ...
    eyebrow: "Luyện gõ · Game",
    h1: "Game luyện gõ phím",
    intro:
