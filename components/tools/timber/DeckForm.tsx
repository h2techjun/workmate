          ...
          {mode === "deck" ? (
            <>
              <div className="rounded-xl bg-gradient-to-br from-amber-500/15 to-orange-500/10 p-4 ring-1 ring-amber-500/20">
                ...
                <dd className="mt-1 text-4xl font-bold tabular-nums text-white">{deck.boardCount}<span className="ml-1 text-base font-medium text-[color:var(--color-text-secondary)]">{t.boardUnit}</span></dd>
              </div>
            ...
            <>
              <div className="rounded-xl bg-gradient-to-br from-amber-500/15 to-orange-500/10 p-4 ring-1 ring-amber-500/20">
                ...
                <dd className="mt-1 text-4xl font-bold tabular-nums text-white">{fence.postCount}<span className="ml-1 text-base font-medium text-[color:var(--color-text-secondary)]">{t.count}</span></dd>
              </div>
              <dl className="space-y-1.5 text-sm">
