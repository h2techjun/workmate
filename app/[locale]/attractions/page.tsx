...
const COPY: Record<Locale, Copy> = {
  ko: {
    ...
    metaDesc:
      "궁궐·해변·전통시장·랜드마크까지, 한국에서 가볼 만한 명소를 사진과 친근한 소개글로 매일 한 곳씩 소개합니다. 가는 법과 입장 팁, 지도, 다른 여행자의 댓글까지 한 페이지에서 모두 확인할 수 있어요.",
  ...
  zh: {
    ...
    metaDesc:
      "宫殿、海滩、传统市场、地标建筑——用心挑选韩国各地值得一去的景点，配上照片与亲切自然的介绍文字，每天更新推荐一处新去处。交通方式、入场贴士、周边地图，以及其他旅行者留下的真实评论，都能在同一页面轻松查看。",
