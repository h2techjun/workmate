...
export async function generateMetadata({
  ...
  const keywords = isKo
    ...
    : isZh
      ? ["结婚礼金", "奠仪", "礼金计算器", "韩国结婚礼金", "礼金金额", "份子钱", "婚丧礼金"]
      : isVi
        ? [
  ...
  return {
    ...
    openGraph: { title, description, type: "website", url: `${SITE_URL}/${locale}/gift-money`, locale: locale === "ko" ? "ko_KR" : locale === "zh" ? "zh_CN" : locale === "vi" ? "vi_VN" : "en_US" },
  };
}
  ...
  return (
    <main className="px-4 pb-16 pt-6 md:px-6 md:pt-10">
      <div className="mx-auto max-w-6xl">
        <Breadcrumbs path="/gift-money" locale={lang} id="gift-money" />
        <header className="mb-8">
          ...
          <p className="mt-2.5 max-w-3xl text-sm leading-relaxed text-[color:var(--color-text-secondary)] md:text-base">
            {lang === "ko"
              ...
              : lang === "zh"
                ? "根据关系与是否出席，推荐婚礼礼金·丧礼奠仪的合适金额——不知道该包多少时的参考标准。"
                : lang === "vi"
