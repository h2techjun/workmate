...
export async function generateMetadata({
  ...
  if (locale === "zh") {
    return {
      ...
      description:
        "只看到健康保险费率7.19%,就以为四大保险总共只扣7%左右,其实差得很远。国民年金、健康保险、长期疗养、雇佣保险、工伤保险逐项拆解之后,员工实际被扣除的比例接近9.5%,以下按2026年最新费率逐条说明。",
    };
  }
  if (locale === "vi") {
    return {
  ...
  return {
    ...
    description:
      "건강보험 7.19%라는 숫자만 보고 4대보험을 7%로 생각하면 오산입니다. 국민연금·건강보험·장기요양·고용보험·산재보험을 항목별로 뜯어보면 실제 차감률은 9.5%에 가깝습니다. 2026년 적용 요율 기준입니다.",
  };
}
