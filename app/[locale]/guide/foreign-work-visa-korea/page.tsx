...
const COPY = {
  ko: {
    ...
    metaDesc:
      "인도·중국·베트남·중앙아시아·영어권까지, 국적에 따라 열리는 한국 취업·체류 비자 경로를 국가별로 정리했습니다. E-9 고용허가제부터 E-7 전문직, 재외동포 F-4, 유학 D-2, 회화지도 E-2, 첨단인재 Top-Tier까지 한눈에 비교합니다.",
    ogLocale: "ko_KR",
    eyebrow: "한국 생활 · 비자",
  ...
  zh: {
    ...
    metaDesc:
      "从印度·中国·越南到中亚各国、英语圈国家,按国籍整理韩国对你开放的工作·居留签证路径。涵盖E-9雇佣许可制、E-7专业职、在外同胞F-4、留学D-2、会话指导E-2、尖端人才Top-Tier,一目了然地比较各条路线。",
    ogLocale: "zh_CN",
    eyebrow: "韩国生活 · 签证",
