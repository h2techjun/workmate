...
const COPY = {
  ko: {
    ...
    metaDesc: "전기·세금·부동산·목조 건축 등 33개 실무 계산기의 사용법과 공식, 관련 법령·KS 표준 출처까지 깊이 있게 풀어낸 가이드 모음입니다. 가이드·현장 노트·도구 페이지가 서로 연결돼 있어 필요한 배경 지식을 바로 찾아볼 수 있어요.",
    ogLocale: "ko_KR",
    eyebrow: "도구 가이드",
  ...
  zh: {
    ...
    metaDesc: "汇集电气、税务、房地产、木结构建筑等六大类共33款韩国实用计算器的深度指南，涵盖具体使用方法、计算公式推导及相关法规与KS标准出处说明。指南、现场笔记与工具页面彼此互相链接，方便随时查阅背景知识与实际案例。",
    ogLocale: "zh_CN",
    eyebrow: "工具指南",
    h1: "韩国实务工具深度指南",
