...
export async function generateMetadata({
  ...
  if (locale === "ko") {
    return {
      ...
      description:
        "건축물 에너지절약 설계기준 별표1을 매주 들여다보는 사람의 정리. 글라스울 140mm만으로는 중부2 외벽 U값 0.17 기준을 통과하지 못합니다. 외단열 추가부터 골조 변경까지 실제로 통과시키는 방법을 다룹니다.",
    };
  }
  if (locale === "zh") {
    return {
      ...
      description:
        "每周查阅《建筑物节能设计标准》附表1的人整理的实操笔记。玻璃棉140mm无法让中部2地区外墙U值达到0.17的上限要求，从增加外保温层到更换骨架尺寸等做法，本文详细说明几种真正能够通过审批的墙体组合方案。",
    };
  }
  if (locale === "vi") {
    return {
