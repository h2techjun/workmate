...
const COPY = {
  ko: {
    ...
    metaDesc:
      "한국 여권으로 무비자 입국이 가능한 나라와 비자·전자허가가 필요한 나라를 한눈에 정리했습니다. 미국 ESTA, 유럽 ETIAS, 일본·중국·베트남·태국의 무비자 체류 기간, 인도 e-비자 신청법까지 2026년 최신 기준으로 안내합니다.",
    ogLocale: "ko_KR",
    eyebrow: "해외여행 · 비자",
  ...
  zh: {
    ...
    metaDesc:
      "一目了然地整理韩国护照免签入境的国家,以及需要签证或电子许可的国家。涵盖美国ESTA申请、欧洲ETIAS、日本·中国·越南·泰国的免签停留期限,以及印度e-签证办理方法,均按2026年最新标准介绍，出发前一次确认清楚。",
    ogLocale: "zh_CN",
    eyebrow: "海外旅行 · 签证",
