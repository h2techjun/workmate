...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: { title, description, type: "website", url: `${SITE_URL}/${locale}/deck-calc`, locale: locale === "ko" ? "ko_KR" : locale === "zh" ? "zh_CN" : "en_US" },
  };
}
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <header className="mb-8">
          <h1 className="text-2xl font-bold tracking-tight md:text-3xl">
            {isKo ? "데크·울타리 자재 계산기" : isZh ? "露台·围栏材料计算器" : "Deck & Fence Calculator"}
          </h1>
