...
const COPY = {
  ko: {
    ...
    metaDesc:
      "AI가 응답을 분석하는 무료 심리테스트 모음입니다. 직장 문화를 8개 축으로 셀프 진단하고 익명 커뮤니티에서 동료·회사와 비교하며, Vertex AI가 답변 신뢰도까지 평가합니다. MBTI류와 다른 깊이 있는 자가진단을 무료·무가입으로 경험하세요.",
    keywords: [
      "심리테스트",
      "MBTI",
      "MBTI 무료",
  ...
  zh: {
    ...
    metaDesc:
      "AI分析回答内容的免费心理测试合集。按8个维度自我诊断职场文化,可在匿名社区与同事、公司互相比较,还有Vertex AI评估回答可信度。有别于MBTI式简单分类,提供更有深度的自我诊断体验,免费且无需注册。",
    keywords: [
      "心理测试",
      "MBTI",
      "MBTI免费",
