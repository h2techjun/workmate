...
export default async function HomePage({
  ...
  const tools: ReadonlyArray<ToolEntry> = [
    ...
    },
    {
      ...
      available: true,
      tag: t("tools.compoundCalc.tag"),
      title: t("tools.compoundCalc.title"),
      description: t("tools.compoundCalc.description"),
    },
    {
      id: "loan-calc",
      href: `/${locale}/loan-calc`,
      available: true,
      tag: t("tools.loanCalc.tag"),
      title: t("tools.loanCalc.title"),
      description: t("tools.loanCalc.description"),
    },
    {
      id: "area-convert",
      href: `/${locale}/area-convert`,
      available: true,
      tag: t("tools.areaConvert.tag"),
      title: t("tools.areaConvert.title"),
      description: t("tools.areaConvert.description"),
    },
    {
      id: "percent-calc",
      href: `/${locale}/percent-calc`,
      available: true,
      tag: t("tools.percentCalc.tag"),
      title: t("tools.percentCalc.title"),
      description: t("tools.percentCalc.description"),
    },
    {
